...
if ((isset($_POST['update']))) {
 ...
 $status= $_POST['status'];
    $query = "UPDATE usertable SET name='$name', last ='$last', mdl='$mdl', email='$email', mobile='$mobile',
     dob = '$dob', gender='$gender', trad_expe='$trad_expe' , address='$address' ,pincode ='$pincode',dmt_yes_no='$dmt_yes_no',
     demat_acco='$demat_acco',code='$code',status='$status'
   where id=$id";
                    ...
                    <div class="card111">
                        ...
                        <form name="form" action="#" method="POST">
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <label>Status</label>
                                    <input type="text" id="user" name="code" value="<?php echo $row['code'] ?>" />
                                </div>
                                <div class="col-sm">
                                    <label>verified/notverified </label>

                                    <input type="text" id="user" name="status" value="<?php echo $row['status'] ?>" />
                                </div>
                            </div>
                            <div class="d-flex p ">
